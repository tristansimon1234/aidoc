...
/**
 * Animation primitives exposed to AI-written scene code via the
 * `Remotion` namespace (repris de l'ancienne plateforme). These encapsulate non-trivial timing / easing
 ...
 *
 * @example
 * <span style={{ fontSize: 36, color: brand.accent }}>
...
interface PulseGlowProps {
  /** Glow color. Default 'currentColor' — caller passes brand.accent. */
  color?: string
 ...
 *
 * @example
 * <Remotion.PulseGlow color={brand.accent} intensity={48}>
 ...
 *   <Remotion.OrbitingDot radius={80} period={90} color={brand.accent} />
 *   <Remotion.OrbitingDot radius={80} period={90} phase={Math.PI} color={brand.accent} />
 * </div>
 */
 ...
 *   <NodeA /><NodeB />
 *   <Remotion.Connector from={{x:10,y:50}} to={{x:90,y:50}} traveling color={brand.accent} />
 * </div>
 */
 ...
 *   from={{x:10,y:50}} to={{x:90,y:50}} speed={60} color={brand.accent}
 * />
 */
 ...
 *   <Remotion.ParticleField count={32} color={brand.accent} />
