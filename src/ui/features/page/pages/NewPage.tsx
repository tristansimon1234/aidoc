  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', margin: '0 0 var(--space-xl)' }}>
        Create a documentation page. Record your screen and the AI will generate documentation automatically.
      </p>
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div style={{ display: 'flex', gap: 'var(--space-sm)', marginTop: 'var(--space-lg)', alignItems: 'center' }}>
          <Button disabled={submitting || !title || !slug} onClick={() => handleCreate('explore')}>
            Create & Record
          </Button>
