...
Doclee transforme une vidéo d'écran en **SOP** (markdown + captures) et en **vidéo commentée**. SaaS payant au crédit.
...
8. Interface : le moins d'écrans et d'options possible, textes en français, CSS dans `web/src/styles.css` (variables de couleur, clair + sombre).
