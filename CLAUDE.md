...
Node 20+ · TypeScript strict · Express 5 · React 19 + Vite · Supabase (auth, Postgres, stockage) · Gemini (`@google/genai`) · Claude (`@anthropic-ai/sdk`, voix off, storyboard et code des scènes marketing) · Remotion (rendu des vidéos marketing, `remotion/`) · ElevenLabs (optionnel) · Stripe · ffmpeg · Vitest.
