(function () {
  ...
  function buildCSS() {
    ...
    return [
      '#aidoc-widget-btn{position:fixed;bottom:24px;' + pos + ':24px;z-index:99999;width:56px;height:56px;border-radius:50%;background:' + C.accent + ';border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,.25);display:flex;align-items:center;justify-content:center;transition:transform .15s,box-shadow .15s}',
